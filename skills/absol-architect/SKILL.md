...
`.absol/CONTEXT.md` (domain vocabulary — use verbatim), `.absol/adr/` (don't re-suggest decided-against things), `.absol/tech-debt.md` (drives Step 4), `.absol/bugs.md`, `vision.md`, `roadmap.md`, `CLAUDE.md`, `state.md`.
